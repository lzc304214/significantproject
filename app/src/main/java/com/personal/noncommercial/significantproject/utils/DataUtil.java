...
import static com.personal.noncommercial.significantproject.utils.ConstUtil.BYTE;
import static com.personal.noncommercial.significantproject.utils.ConstUtil.GB;
import static com.personal.noncommercial.significantproject.utils.ConstUtil.KB;
import static com.personal.noncommercial.significantproject.utils.ConstUtil.MB;
...
public class DataUtil {
     ...
     */
    public static double byte2Size(long byteNum, ConstUtil.MemoryUnit unit) {
     ...
     * @return 字节数
     */
    public static long size2Byte(long size, ConstUtil.MemoryUnit unit) {
        if (size < 0) return -1;
        switch (unit) {
            default:
            case BYTE:
